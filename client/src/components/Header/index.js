        ...
        <nav className="flex items-center justify-between flex-wrap bg-red p-6">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div className="text-sm lg:flex-grow">
                    <Link to="/" className="block mt-4 lg:inline-block lg:mt-0 text-red-200 hover:text-white mr-4">
                        Home
                    </Link>
                    <Link to="/features" className="block mt-4 lg:inline-block lg:mt-0 text-red-200 hover:text-white mr-4">
                        Features
                    </Link>
                    <Link to="/user" className="block mt-4 lg:inline-block lg:mt-0 text-red-200 hover:text-white">
                        Users
                    </Link>
                </div>
                <div>
